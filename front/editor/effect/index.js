...
export default (state, action, send) => {
  ...
  if (action.type == 'config_always_enable') send({type: 'config_remove_default_enabled', fullPath: action.fullPath})
  if (action.type == 'config_default_enable') send({type: 'config_remove_always_enabled', fullPath: action.fullPath})
