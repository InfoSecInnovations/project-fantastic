...
eval("const generateQuery = obj => Object.entries(obj).map(v => `${v[0]}=${v[1]}`).join('&')\r\n\r\nmodule.exports = generateQuery\n\n//# sourceURL=webpack:///../common/effect/generatequery.js?");
